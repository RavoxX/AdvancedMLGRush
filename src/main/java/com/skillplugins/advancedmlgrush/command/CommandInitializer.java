...
public class CommandInitializer implements Initializer {
    ...
    public void init(final @NotNull Injector injector) {
        ...
        javaPlugin.getCommand("perks").setExecutor(injector.getInstance(GadgetsCommand.class));
        ...
        javaPlugin.getCommand("ping").setExecutor(injector.getInstance(PingCommand.class));
    }
}
